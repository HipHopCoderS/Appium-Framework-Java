...
public class Android_UI extends Android_DriverStart {
	...
	public static void UIswipe(Double startX, Double startY, Double endX,
			Double endY, Double duration, int repeat, WebElement element) {
		...
		swipeObj.put("element",
				Double.valueOf(((RemoteWebElement) element).getId()));
